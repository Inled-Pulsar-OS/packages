...
2. **Desktop-Only OTP Pairing**: The 6-digit PIN is **never** sent or echoed to the Telegram chat. It is generated and displayed exclusively on the local Pulsar OS screen in Sayri Cajita (`Gateways -> 🔑 Show Pairing PIN`).
...
2. In Sayri Cajita, open **Gateways -> ⚙️ Set TELEGRAM_BOT_TOKEN** and save your token. Sayri automatically launches the supervisor daemon.
